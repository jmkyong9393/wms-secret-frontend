    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={handleClose}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h3 className="text-base font-bold text-gray-800">엑셀 일괄 등록</h3>
          <button
            type="button"
            onClick={handleClose}
          ...
          {!results && (
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 bg-blue-50 border border-blue-100 p-4 rounded-xl space-y-3">
                ...
                <Button variant="outline" className="w-full bg-white" onClick={downloadTemplate}>
                  <Download className="w-4 h-4 mr-2" />
                  양식 다운로드
                </Button>
              </div>
              <div className="flex-1 bg-gray-50 border border-gray-200 p-4 rounded-xl space-y-3">
          ...
          {rows.length > 0 && !results && (
            <div className="space-y-3 border border-gray-200 rounded-xl overflow-hidden">
              <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                <h4 className="font-semibold text-sm text-gray-700">업로드 데이터 미리보기</h4>
                <span className="text-xs text-gray-500">총 {rows.length}명</span>
              </div>
                ...
                <table className="w-full text-sm text-left">
                  <thead>
                    <tr className="text-gray-500 border-b border-gray-100">
                      ...
                      <th className="py-2 font-medium text-gray-400">비밀번호</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rows.map((row, i) => (
                      <tr key={i} className="border-b border-gray-50 last:border-0">
                        ...
                        <td className="py-2 text-gray-400 font-mono text-xs">{"*".repeat(8)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl space-y-3">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-sm text-gray-700">초기 비밀번호 다운로드</h4>
