  ...
  return (
    <>
      {/* 📱 모바일 메뉴 버튼 (md 미만에서만 노출).
          기준을 lg(1024px) -> md(768px)로 낮췄다. 종전에는 노트북이나
            ...
            <>
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-[10px] text-gray-400 dark:text-gray-500 font-mono font-bold mt-0.5">Enterprise v2.15.2.0</span>
                </div>
              </div>
              <button
